...
- chốt pricing rule version schema và policy
- implement quote estimation use-case + API
- chốt order aggregate schema + lifecycle invariants
- implement order creation với idempotency và snapshot persistence
- implement order detail + timeline reads
...
- [ ] authenticated user có thể request quote theo contract đã chốt
- [ ] tạo order giữ đúng idempotency và pricing snapshot semantics
- [ ] order detail/timeline reads ổn định cho consumer phases

## Task Index

| ID | Type | Verification mode | Depends on | Output |
|---|---|---|---|---|
| `BE-P02-T01` | `schema` | `runtime` | `BE-P00-T03`, `BE-P01-T03` | Pricing rule version schema + policy |
| `BE-P02-T02` | `api` | `runtime` | `BE-P02-T01`, `BE-P00-T04` | Quote estimation API/use-case |
| `BE-P02-T03` | `schema` | `runtime` | `BE-P02-T01` | Order aggregate schema + lifecycle invariants |
| `BE-P02-T04` | `application` | `runtime` | `BE-P02-T02`, `BE-P02-T03`, `BE-P01-T03` | Order creation idempotency + snapshot persistence |
| `BE-P02-T05` | `api` | `runtime` | `BE-P02-T04`, `BE-P01-T04` | Order detail + timeline read APIs |
