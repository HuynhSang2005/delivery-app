...
- chốt chat schema và access policy
- implement chat API + realtime messaging baseline
- định nghĩa worker extraction boundary cho async jobs
- bổ sung smoke runbook và production-readiness checklist
...
- [ ] chat contracts và access policy ổn định
- [ ] async handoff boundary rõ và không phá synchronous baseline
- [ ] smoke checklist đủ để re-verify critical path

## Task Index

| ID | Type | Verification mode | Depends on | Output |
|---|---|---|---|---|
| `BE-P06-T01` | `schema` | `runtime` | `BE-P03-T05`, `BE-P00-T03` | Order chat schema + access policy |
| `BE-P06-T02` | `realtime` | `runtime` | `BE-P06-T01`, `BE-P03-T06` | Chat APIs + realtime messaging baseline |
| `BE-P06-T03` | `ops` | `runtime` | `BE-P03-T04`, `BE-P04-T03` | Async jobs handoff to worker boundary |
| `BE-P06-T04` | `test` | `target-state` | `BE-P06-T02`, `BE-P06-T03` | Smoke runbook + production-readiness checklist |
