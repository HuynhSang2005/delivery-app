---
name: refactor
description: 'Surgical code refactoring to improve maintainability without changing behavior. Covers extracting functions, renaming variables, breaking down god functions, improving type safety, eliminating code smells, and applying design patterns. Technical refactoring only; use plan-work for refactor planning and execute-work for plan execution.'
license: MIT
---
...
- This skill is for technical code transformation only.
- Do not use this skill to create project plans; use `plan-work`.
- Do not use this skill to run end-to-end implementation checklists; use `execute-work`.
